...
$txt['elga_location_variants'] = ['Не менять', 'Перед', 'После', 'Дочерний'];
$txt['elga_album_name'] = 'Название';
$txt['elga_admin'] = 'Админ';
$txt['elga_edit'] = 'Редактировать';
$txt['elga_edit_album'] = 'Изменить альбом';
...
// form
$txt['elga-field-album'] = 'Album';
$txt['elga-field-name'] = 'Title';
$txt['elga-field-file'] = 'File';
